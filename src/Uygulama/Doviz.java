...
public class Doviz extends javax.swing.JFrame {
    ...
    ArrayList<String> doviz=new ArrayList<>();
    public Doviz(String tc,String musteriid,String ad,String soyad,String ibann,String hesapno,String hesaptur,String gecerli_tarih,String maas )
    {
         ...
         jTextField14.setText(ibann);
         jTextField14.setEditable(false);
         jTextField5.setText(hesapno);
         jTextField5.setEditable(false);
         jTextField6.setText(hesaptur);
         jTextField6.setEditable(false);
         jTextField7.setText(gecerli_tarih);
         jTextField7.setEditable(false);
         jTextField8.setText(maas);
         jTextField8.setEditable(false);
     
         String q="call doviz_getir()";
        try {
            ResultSet rs=db.baglan().executeQuery(q);
            jComboBox2.removeAll();
            while(rs.next())
            {
            doviz.add(rs.getString(1));
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Vadesiz Hesap"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      String q="call hesap_olustur_doviz(?,?,?,?,?,?)";
        PreparedStatement pr=db.preBaglan(q);
        
        try {
            pr.setString(1, "5");
            pr.setString(2, jTextField5.getText().trim());
            pr.setString(3, jTextField2.getText().trim());
            pr.setString(4, jTextField7.getText().trim());
            pr.setString(5, jTextField14.getText().trim());
            int x=jComboBox2.getSelectedIndex();
            pr.setString(6, doviz.get(x));
            
            pr.execute();
            JOptionPane.showMessageDialog(rootPane, "Döviz Hesabı Başarıyla oluşturuldu");
            dispose();
            
            
        } catch (SQLException ex) {
            System.out.println("döviz hesabı hatası :"+ex);
        }
        finally{db.kapat();}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Doviz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
